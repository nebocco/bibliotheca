...
mod tests {
    ...
    fn test_fps_inverse() {
        ...
        for _ in 0..100 {
            ...
            let a: Vec<Fp> = once(Fp::new(rng.gen_range(1..Fp::P)))
    ...
    fn test_fps_log() {
        ...
        for _ in 0..100 {
            ...
            for i in 1..=precision {
                acc = Fp::convolution(
                    once(Fp::new(0)).chain(a[1..].iter().copied()).collect(),
                    acc,
                );
